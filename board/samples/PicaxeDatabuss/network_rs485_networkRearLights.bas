...
symbol networkDelay     = 35 ' detta värde motsvarar hur lång tid det tar för den
...
#ifndef DebugCommunication
		if rxPin = 1 then 
#else
		if rxPin = 1 or rxPin = 0 then ' in debug, disable cable check
#endif
		' sänd meddelande
			ioPin = 1
